...
In the past, these pages were hand-coded and had to be manually updated in several places (not just this website) each time a provider's status changed. My solution was to create a component that queried our online provider finder's' API and returned the most updated physician biographies for any given team page.
